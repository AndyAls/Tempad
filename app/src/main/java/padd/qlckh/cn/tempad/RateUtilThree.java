...
//    010410000816AB0007FFB80007FCE50007FFB9BE6F
     ...
     */
    private static final String EMPTY_WEIGHT1 = "040C00084F5700084B4A0008639BA02C";
    private static final String EMPTY_WEIGHT2 = "040C00084EC400084C9400086399617A";
    private static final String EMPTY_WEIGHT3 = "040C00084FD600084A2C000863960466";
    private static final String EMPTY_WEIGHT4 = "040C00084DFE00084A55000863998663";
    private static final String EMPTY_WEIGHT5 = "040C00084FF100084C060008639823F3";
    //1000g
    private static final String KG_WEIGHT1 = "040C00085402000850AC000866FB1A4A";
    private static final String KG_WEIGHT2 = "040C000854350008515C000866FB29BF";
    private static final String KG_WEIGHT3 = "040C000852C20008503F00086776EFB8";
    private static final String KG_WEIGHT4 = "040C0008538D000850EA00086773039F";
    private static final String KG_WEIGHT5 = "040C0008538B00084FD8000867731394";
    ...
    public static String getCurrentWeight(String[] hexStr, ResponeDao.ResponeBean responeBean, String order) {
        ...
        double v1 = b1 - Double.parseDouble(responeBean.getFwight());
        double v2 = b2 - Double.parseDouble(responeBean.getBwight());
        double v3 = b3 - Double.parseDouble(responeBean.getZwight());
        double max;
        switch (order) {
            case "01":
                max = v1;
