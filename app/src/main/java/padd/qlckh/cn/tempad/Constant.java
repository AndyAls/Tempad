...
public interface Constant {
     ...
     * 接口传前个用户的出货状态
     */
    String QIREN_ID_KEY = "qiren_id_key";

    String QIREN_FLAG_KEY = "qiren_flag_key";

    String QIREN_HCODE_ID_KEY = "qiren_hcode_id_key";
    String QIREN_ADDTIEM_KEY = "qiren_addtiem_key";
